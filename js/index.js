...
$(function(){
   ...
   //2.监听关闭按钮的点击
    ...
    function starWolfAnimation(){
        ...
        //2.定义一个数组保存灰太狼或小灰灰出现的位置
        var arrPos = [{left:"100px",top:"115px"},{left:"20px",top:"160px"},{left:"190px",top:"142px"},{left:"105px",top:"193px"},{left:"19px",top:"221px"},{left:"202px",top:"212px"},{left:"120px",top:"275px"},{left:"30px",top:"295px"},{left:"209px",top:"279px"}];
        //3.创建一个图片
